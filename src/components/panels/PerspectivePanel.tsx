  ...
  return (
    <div className="flex flex-col overflow-y-auto flex-1">
      ...
      <div className="px-3 py-3 flex flex-col gap-3">
        <p className="text-[10px] text-[#c1c1c1] leading-relaxed">
          Drag corner handles to distort the element. Edge handles move two corners simultaneously.
        </p>

        {!el && (
          <p className="text-[10px] text-[#595959]">Select an element to edit perspective.</p>
        )}

        {el && (
          <div className="flex flex-col gap-2">
            <div className="text-[10px] text-[#c1c1c1]">
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 bg-editor-elevated border border-editor-border rounded text-[#c1c1c1] hover:text-editor-text transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Reset Perspective
            </button>
          </div>
