      ...
      <div className="flex flex-col px-3 py-2 gap-2">
            ...
            <button
              ...
              className={cn(
                ...
                tr.type === t.value
                  ...
                  : 'bg-editor-elevated border-editor-border text-[#f2f2f2] hover:text-editor-text hover:border-editor-border-strong'
              )}
            >
              {t.label}
            </button>
        ...
        {tr.type !== 'none' && (
          <>
            ...
            <p className="text-2xs text-[#f2f2f2] bg-editor-elevated rounded px-2 py-1.5">
