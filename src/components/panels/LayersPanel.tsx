  ...
  return (
    <div className="flex flex-col overflow-y-auto flex-1">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-editor-border">
        ...
        <span className="text-xs text-editor-muted ml-auto">{scene.elements.length}</span>
      </div>

      {sorted.length === 0 && (
        <p className="text-xs text-editor-muted px-3 py-4 text-center">No elements in this scene.</p>
      )}
          ...
          >
            ...
            <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="text-editor-muted hover:text-editor-text p-0.5"
                title="Bring forward"
              >
                <ArrowUp size={10} />
              </button>
              ...
              <button
                ...
                className="text-editor-muted hover:text-red-400 p-0.5"
                title="Delete"
              >
                <Trash2 size={10} />
              </button>
