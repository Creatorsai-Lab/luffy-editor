    ...
    <div className="flex flex-col overflow-y-auto flex-1">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-2xs text-[#c1c1c1]">PNG · JPG · GIF · WebP</p>
        </div>
      </div>

      {imageAssets.length === 0 && (
        <p className="text-xs text-[#c1c1c1] px-3 py-4 text-center">No images yet.</p>
      )}
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-editor-panel">
              <img
                ...
                onError={e => {
                  ...
                  if (p) p.innerHTML = '<div class="flex items-center justify-center w-full h-full"><svg class="w-8 h-8 text-[#c1c1c1]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg></div>'
                }}
              />
            </div>
